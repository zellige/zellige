...
instance Prelude'.Enum GeomType where
  ...
  succ _
   = Prelude'.error "hprotoc generated code: succ failure for type Data.Geometry.VectorTile.Protobuf.Internal.Vector_tile.Tile.GeomType"
  pred POINT = UNKNOWN
  pred LINESTRING = POINT
  pred POLYGON = LINESTRING
  pred _
   = Prelude'.error "hprotoc generated code: pred failure for type Data.Geometry.VectorTile.Protobuf.Internal.Vector_tile.Tile.GeomType"
